...
class TLowLevelPlatform : public redBlocks::Core::NoInstanceBase
{
  public:
    ...
    typedef redBlocks::HAL::Drivers::TDigitalInputDriverStub<0> DiPowerSupervision;
   ...
   // typedef redBlocks::HAL::Drivers::TDigitalInputDriverStub<9> DiPowerSupervision;
    ...
    static void initLowLevelDrivers()
    {
      ...
      SimulationStubs::DigitalInput::add<DiPowerSupervision>();
      ...
      SimulationStubs::DigitalInput::add<DiPowerSupervision>(SimulationStubs::DigitalInput::TRIGGER_EDGE_BOTH);
